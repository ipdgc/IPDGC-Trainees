...
ggsave("resilience_UKB.jpeg", dpi = 600, units = "in", height = 6, width = 6)
 ...
 #                 Generalized Linear Model Regression Results                  
# ==============================================================================
# Dep. Variable:                  PHENO   No. Observations:                 2396
# Model:                            GLM   Df Residuals:                     2381
# Model Family:                Binomial   Df Model:                           14
# Link Function:                  logit   Scale:                          1.0000
# Method:                          IRLS   Log-Likelihood:                -1136.1
# Date:                Mon, 28 Jun 2021   Deviance:                       2272.2
# Time:                        12:51:51   Pearson chi2:                 2.30e+03
# No. Iterations:                     5                                         
# Covariance Type:            nonrobust                                         
# ==================================================================================
#                      coef    std err          z      P>|z|      [0.025      0.975]
# ----------------------------------------------------------------------------------
# Intercept         -9.6929      0.709    -13.675      0.000     -11.082      -8.304
# PRS_Z              0.0274      0.052      0.522      0.602      -0.075       0.130
# PC1               -0.0081      0.034     -0.238      0.812      -0.075       0.059
# PC2               -0.0441      0.035     -1.251      0.211      -0.113       0.025
# PC3                0.0025      0.033      0.075      0.940      -0.062       0.067
# PC4                0.0141      0.025      0.559      0.576      -0.035       0.064
# PC5                0.0148      0.011      1.339      0.180      -0.007       0.036
# PC6                0.0121      0.033      0.372      0.710      -0.052       0.076
# PC7                0.0202      0.029      0.684      0.494      -0.038       0.078
# PC8               -0.0175      0.030     -0.588      0.557      -0.076       0.041
# PC9                0.0056      0.012      0.450      0.653      -0.019       0.030
# PC10               0.0016      0.025      0.065      0.948      -0.047       0.051
# AGE_OF_RECRUIT     0.1378      0.009     15.185      0.000       0.120       0.156
# TOWNSEND           0.0025      0.018      0.138      0.891      -0.033       0.038
# GENETIC_SEX        0.5959      0.105      5.702      0.000       0.391       0.801
# ==================================================================================
